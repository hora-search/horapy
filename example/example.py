...
def make_indices(dimensions):
    indices = []
    indices.append(hora.BruteForceIndex())
    indices.append(hora.BPForestIndex(dimensions, 6, -1))
    indices.append(hora.HNSWIndex(10, 10000000, 200,
                                     300, 20, 200, False))
    indices.append(hora.PQIndex(10, 10, 4,
                                   100))
    indices.append(hora.SatelliteSystemGraphIndex(
